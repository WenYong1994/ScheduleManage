package com.example.weny.uilibrary.customview.sidesliplist.suspendsilderecyclerview;
...
public class SuspendSlideRecyclerGroup extends FrameLayout {
    View mSuspensionBar;
    ...
    public SuspendSlideRecyclerGroup(@NonNull Context context) {
        super(context);
//        init();
    }

    public SuspendSlideRecyclerGroup(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public SuspendSlideRecyclerGroup(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
