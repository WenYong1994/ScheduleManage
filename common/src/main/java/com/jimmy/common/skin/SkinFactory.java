...
public class SkinFactory implements LayoutInflater.Factory2 {
    ...
    private static OnChangeSkinListener allOnChangeSkinListener;

    public static void setAllOnChangeSkinListener(OnChangeSkinListener allOnChangeSkinListener) {
        SkinFactory.allOnChangeSkinListener = allOnChangeSkinListener;
    }
    ...
    public void changeSkin() {
        for (SkinView skinView : listCacheSkinView) {
            if(onChangeSkinListener!=null){//优先执行成员变量的
                onChangeSkinListener.onChangeSkin(skinView.view,skinView.attrsMap);
                continue;
            }
            if(allOnChangeSkinListener!=null){
                allOnChangeSkinListener.onChangeSkin(skinView.view,skinView.attrsMap);
            }
        }
    }
    ...
    public static void release(){
        allOnChangeSkinListener = null;
    }


    public interface OnChangeSkinListener{

        void onChangeSkin(View view,HashMap<String, String> attrsMap);
